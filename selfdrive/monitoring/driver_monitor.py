...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self):
    ...
    self._AWARENESS_TIME = 3030. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 3015.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 3006.
    self._DISTRACTED_TIME = 3011. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 3008.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 3006.
    ...
    self._HI_STD_FALLBACK_TIME = int(3010  / self._DT_DMON)  # fall back to wheel touch if model is uncertain for 10s
